...
namespace Lumina.SecurityService.Data.Migrations
{
    ...
    public partial class AddTransactionalOutbox : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Existing installations may contain historical duplicates. Keep the
            // newest value so ArtifactId can become the stable idempotency key.
            migrationBuilder.Sql("""
                DELETE FROM "HashRecords" AS old
                USING "HashRecords" AS keep
                WHERE old."ArtifactId" = keep."ArtifactId"
                  AND (old."CreatedAt", old."Id") < (keep."CreatedAt", keep."Id");
                """);

            migrationBuilder.CreateIndex(
                name: "IX_HashRecords_ArtifactId",
                table: "HashRecords",
                column: "ArtifactId",
                unique: true);
