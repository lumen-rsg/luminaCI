...
namespace Lumina.ScannerService.Data.Migrations
{
    ...
    public partial class AddTransactionalOutbox : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Retain the newest report for each artifact before enforcing the
            // idempotency key. Vulnerabilities cascade with their old report.
            migrationBuilder.Sql("""
                DELETE FROM "CveReports" AS old
                USING "CveReports" AS keep
                WHERE old."ArtifactId" = keep."ArtifactId"
                  AND (old."CreatedAt", old."Id") < (keep."CreatedAt", keep."Id");
                """);

            migrationBuilder.CreateIndex(
                name: "IX_CveReports_ArtifactId",
                table: "CveReports",
                column: "ArtifactId",
                unique: true);
