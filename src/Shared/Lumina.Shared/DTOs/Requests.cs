...
// Pipeline DTOs
public record CreatePipelineRequest(string Name, string Description, List<CreatePipelineStepRequest> Steps, List<string> Tags, string? GitRepoUrl = null, string? GitBranch = null, string? SpecPath = null, string? WebhookSecret = null);
